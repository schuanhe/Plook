<template>
  ...
  <div id="div-main" class="div-main">
    <el-row>
      ...
      <el-col :span="6">
        <el-scrollbar ref="scrollbarRef" max-height="640px">
          <chat v-for="item in getRoomChatInfoMassgs" :key="item" :chats="item" :user-name="getUserUserName" @ScrollbarRef="onScrollbarRef"/>
        </el-scrollbar>
        <div class="send-msg">
    ...
    <!-- 房间设置抽屉 -->
<el-drawer v-model="drawer.setRoom" direction="btt">
        <template #header>
            <h4>房间设置</h4>
        </template>
        <template #default>
